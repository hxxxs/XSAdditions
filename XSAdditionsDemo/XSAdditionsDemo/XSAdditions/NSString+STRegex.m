...
//- (BOOL)isValidPwd
//{
//    NSString *character = @"((?=[\x21-\x7e]+)[^A-Za-z0-9])";
//    return [self isValidWithMinLenth:KPwdTextFieldMinLenth
//                         maxLenth:KPwdTextFieldMaxLenth
//                   containChinese:NO
//                    containDigtal:YES
//                    containLetter:YES
//            containOtherCharacter:character
