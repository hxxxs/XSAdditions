...
@implementation UIColor (XSAdditions)
...
+ (instancetype)xs_colorWithHex:(uint32_t)hex {
    ...
    return [self xs_colorWithRed:r green:g blue:b];
}

+ (instancetype)xs_randomColor {
    return [UIColor xs_colorWithRed:arc4random_uniform(256) green:arc4random_uniform(256) blue:arc4random_uniform(256)];
}
